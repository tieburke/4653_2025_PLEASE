...
public class RobotContainer {
    ...
    /* Driver Buttons */
    // private final JoystickButton flipAxes = new JoystickButton(driver,
    ...
    public RobotContainer() {
        ...
        elevator.setDefaultCommand(new DefaultElevator(elevl4Button, elevl3Button, elevl2Button, elevl1Button,
