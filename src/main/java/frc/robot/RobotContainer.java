...
public class RobotContainer {
    ...
    public static double limelight_aim_proportional(String leftRight){    
        double kP = -.01;
        if(leftRight = "left"){
            double targetingAngularVelocity = LimelightHelpers.getTX("limelightL") * kP;
        }
        else{
            double targetingAngularVelocity = LimelightHelpers.getTX("limelightR") * kP;
        }
    ...
    public static double limelight_range_proportional(String leftRight){    
        double kP = .01;
        if(leftRight = "left"){
            double targetingForwardSpeed = LimelightHelpers.getTY("limelightL") * kP;
        }
        else{
            double targetingForwardSpeed = LimelightHelpers.getTY("limelightR") * kP;
        }
