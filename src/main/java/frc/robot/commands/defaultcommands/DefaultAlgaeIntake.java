...
public class DefaultAlgaeIntake extends Command {
    ...
    public DefaultAlgaeIntake(BooleanSupplier horizontalPos, BooleanSupplier verticalPos, BooleanSupplier reset,
            DoubleSupplier aINOUT, DoubleSupplier manualDrive, AlgaeIntake algaeIntake) {
