...
public class DefaultElevator extends Command{
    ...
    public DefaultElevator(BooleanSupplier manualDriveUp, BooleanSupplier manualDriveDown, Elevator elevatorThing){//BooleanSupplier l1, BooleanSupplier l2, BooleanSupplier l3, BooleanSupplier l4, BooleanSupplier manualDriveUp, BooleanSupplier manualDriveDown){
        // L1 = l1;
        // L2 = l2;
        // L3 = l3;
        // L4 = l4;
