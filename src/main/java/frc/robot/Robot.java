...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // Color.kDarkGreen, Color.kWhite);
    // LEDPattern pattern = base.scrollAtAbsoluteSpeed(InchesPerSecond.of(10),
    // Meters.of(1.0/60));
    ...
    // Filesystem.getDeployDirectory().toPath().resolve(trajectory1JSON);
    // trajectory1 = TrajectoryUtil.fromPathweaverJson(trajectoryPath1);
    // } catch (IOException ex) {
    // DriverStation.reportError("Unable to open trajectory: " + trajectory1JSON,
    // ex.getStackTrace());
    // }

    // try {
    // Path trajectoryPath2 =
    // Filesystem.getDeployDirectory().toPath().resolve(trajectory2JSON);
    // trajectory2 = TrajectoryUtil.fromPathweaverJson(trajectoryPath2);
    // } catch (IOException ex) {
    // DriverStation.reportError("Unable to open trajectory: " + trajectory2JSON,
    // ex.getStackTrace());
    // }
  }
