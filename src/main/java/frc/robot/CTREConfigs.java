...
public final class CTREConfigs {
    ...
    public CTREConfigs() {
        ...
        swerveCanCoderConfig.MagnetSensor.AbsoluteSensorDiscontinuityPoint = 1; // apparently this sets it to the same
                                                                                // range we had before
    ...
    // swerveAngleConfig.smartCurrentLimit(Constants.Swerve.angleContinuousCurrentLimit,
    ...
    // /* Swerve Angle Motor Configurations */
    // swerveDriveConfig.smartCurrentLimit(Constants.Swerve.driveContinuousCurrentLimit,
